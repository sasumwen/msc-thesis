#!/usr/bin/env python3
"""
train_unet3d_ce_patch.py

Patch-based training for UNet3D using cross-entropy (CE) only.
"""
...
CHECKPOINT_DIR = "unet3d_ce_patch_checkpoints"
os.makedirs(CHECKPOINT_DIR, exist_ok=True)

LOG_FILE = "unet3d_ce_patch_training.log"
CSV_LOG_FILE = "unet3d_ce_patch_training.csv"
...
logging.info("=== Starting patch-based training for UNet3D (CE-only) ===")
...
logging.info("=== UNet3D Training Complete! ===")
