"""
test_train_unet3d_ce_patch.py

Test script for patch-based training of UNet3D using cross-entropy only.
"""
...
CHECKPOINT_PATH = "unet3d_ce_patch_checkpoints/epoch_102.pth"
...
def run_test():
    ...
    print("UNet3D (CE-only) test completed successfully.")
